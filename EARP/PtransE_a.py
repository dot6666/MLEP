...
class PtransE_a(nn.Module):
    ...
    def entity_embedding_rich(self,indices):
        ...
        return self.entity_embedding(indices) * self.describe_embedding(indices) * self.type_embedding(indices)
